...
public class RunConfUtil extends BaseConfigUtil {
    ...
    public static void setDerivedStaticResourcePath(String casePath) {
        ...
        COMMON.RESOURCE_LOCAL_PATH = COMMON.RESOURCE_PATH;
    }
